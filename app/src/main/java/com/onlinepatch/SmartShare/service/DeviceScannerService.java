...
import com.onlinepatch.SmartShare.util.AddressedInterface;
import com.onlinepatch.SmartShare.util.AppUtils;
import com.onlinepatch.SmartShare.util.NetworkDeviceLoader;
import com.onlinepatch.SmartShare.util.NetworkDeviceScanner;
...
{
    public static final String ACTION_SCAN_DEVICES = "com.onlinepatch.SmartShare.intent.action.SCAN_DEVICES";
    public static final String ACTION_SCAN_STARTED = "com.onlinepatch.SmartShare.intent.action.SCAN_STARTED";
    public static final String ACTION_DEVICE_SCAN_COMPLETED = "com.onlinepatch.SmartShare.intent.action.DEVICE_SCAN_COMPLETED";

    public static final String EXTRA_SCAN_STATUS = "com.onlinepatch.SmartShare.intent.extra.SCAN_STATUS";

    public static final String STATUS_OK = "com.onlinepatch.SmartShare.intent.status.OK";
    public static final String STATUS_NO_NETWORK_INTERFACE = "com.onlinepatch.SmartShare.intent.status.NO_NETWORK_INTERFACE";
    public static final String SCANNER_NOT_AVAILABLE = "com.onlinepatch.SmartShare.intent.status.SCANNER_NOT_AVAILABLE";
