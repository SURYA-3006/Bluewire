...
import com.onlinepatch.SmartShare.base.AppConfig;
import com.onlinepatch.SmartShare.base.Keyword;
import com.onlinepatch.SmartShare.db.AccessDatabase;
import com.onlinepatch.SmartShare.fragment.FileListFragment;
import com.onlinepatch.SmartShare.util.AppUtils;
import com.onlinepatch.SmartShare.util.CommunicationBridge;
import com.onlinepatch.SmartShare.util.CommunicationNotificationHelper;
import com.onlinepatch.SmartShare.util.DynamicNotification;
import com.onlinepatch.SmartShare.util.FileUtils;
import com.onlinepatch.SmartShare.util.HotspotUtils;
import com.onlinepatch.SmartShare.util.NetworkDeviceLoader;
import com.onlinepatch.SmartShare.util.NetworkUtils;
import com.onlinepatch.SmartShare.util.NotificationUtils;
import com.onlinepatch.SmartShare.util.NsdDiscovery;
import com.onlinepatch.SmartShare.util.TimeUtils;
...
import com.onlinepatch.SmartShare.model.TextStreamObject;
import com.onlinepatch.SmartShare.model.TransferGroup;
import com.onlinepatch.SmartShare.model.TransferInstance;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.onlinepatch.SmartShare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.onlinepatch.SmartShare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.onlinepatch.SmartShare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.onlinepatch.SmartShare.action.IP";
    public static final String ACTION_END_SESSION = "com.onlinepatch.SmartShare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.com.onlinepatch.SmartShare.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.onlinepatch.SmartShare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.onlinepatch.SmartShare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.onlinepatch.SmartShare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.onlinepatch.SmartShare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.onlinepatch.SmartShare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.onlinepatch.SmartShare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.onlinepatch.SmartShare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.onlinepatch.SmartShare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.onlinepatch.SmartShare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.onlinepatch.SmartShare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.onlinepatch.SmartShare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.onlinepatch.SmartShare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.onlinepatch.SmartShare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.onlinepatch.SmartShare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.onlinepatch.SmartShare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.onlinepatch.SmartShare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.onlinepatch.SmartShare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.onlinepatch.SmartShare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.onlinepatch.SmartShare.transaction.action.REQUEST_WEBSHARE_STATUS";
