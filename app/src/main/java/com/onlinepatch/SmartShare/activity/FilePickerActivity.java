...
{
    public static final String ACTION_CHOOSE_DIRECTORY = "com.com.onlinepatch.SmartShare.intent.action.CHOOSE_DIRECTORY";
    public static final String ACTION_CHOOSE_FILE = "com.com.onlinepatch.SmartShare.intent.action.CHOOSE_FILE";
